...
ldflags= -X gitlab.com/NebulousLabs/writeaheadlog/build.GitRevision=${GIT_DIRTY}${GIT_REVISION} \
-X "gitlab.com/NebulousLabs/writeaheadlog/build.BuildTime=${BUILD_TIME}"
